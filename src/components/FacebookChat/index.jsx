...
const FacebookChat = ({
  ...
  return (
    <>
    <section
      className={category === "facebook" ? "w-72 flex flex-col flex-shrink-0 transition pr-8 overflow-y-auto" : "hidden"}
    >
      <div className="flex justify-between w-full py-8 items-center ">
        <h3 className="text-md font-bold opacity-70">Messenger</h3>
      ...
      <div className="border-b border-gray-200 pb-5">
        <div className="flex gap-7 text-gray-300 text-sm items-center mb-4">
          From: <img src={MessengerIcon} className="w-6" />
        </div>
