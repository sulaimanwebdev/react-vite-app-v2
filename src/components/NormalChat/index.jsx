...
const NormalChat = ({
  ...
  return (
    <>
    <section
      className={category === "normalChat" ? "w-72 flex flex-col flex-shrink-0 transition pr-8 overflow-y-auto" : "hidden"}
    >
      <div className="flex justify-between w-full py-8 items-center ">
        <h3 className="text-md font-bold opacity-70">Message</h3>
      ...
      <div className="border-b border-gray-200 pb-5">
        <div className="flex gap-7 text-gray-300 text-sm items-center mb-4">
          From: <i class="fas fa-comment-dots text-4xl"></i>
        </div>
