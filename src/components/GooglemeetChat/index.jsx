...
import icon from "../../assets/images/logo/google-meet.png";
...
const GooglemeetChat = ({
  ...
  const [subtitle, setsubtitle] = useState('Metting Subtitle');
  ...
  return (
    <>
    <section
      className={category === "googlemeet" ? "w-72 flex flex-col flex-shrink-0 transition pr-8 overflow-y-auto" : "hidden"}
    >
      <div className="flex justify-between w-full py-8 items-center ">
        <h3 className="text-md font-bold opacity-70">Google Meet</h3>
      ...
      <div className="font-bold text-lg mt-5 opacity-80">Google Meets</div>
      ...
      className="w-full bg-blue-500 rounded-xl py-3 transition hover:bg-blue-600  text-white">Start Meeting</button>
        ...
        <div className='opacity-80'>Google Meets Home</div>
        </div>
        ...
        <div className="text-sm mt-1 opacity-70 mb-3">Channel</div>
