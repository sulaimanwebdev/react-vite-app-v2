...
import icon from "../../assets/images/logo/whatsapp.png";
...
const WhatsappChat = ({
  ...
  return (
    <>
    <section
      className={category === "whatsapp" ? "w-72 flex flex-col flex-shrink-0 transition pr-8 overflow-y-auto" : "hidden"}
    >
      <div className="flex justify-between w-full py-8 items-center ">
        <h3 className="text-md font-bold opacity-70">Whatsapp</h3>
