...
import icon from "../../assets/images/logo/pipedrive.png";
...
const PipedriveChat = ({
  ...
  return (
    <>
    <section
      className={category === "pipedrive" ? "w-72 flex flex-col flex-shrink-0 transition pr-8 overflow-y-auto" : "hidden"}
    >
      <div className="flex justify-between w-full py-8 items-center ">
        <h3 className="text-md font-bold opacity-70">Pipedrive</h3>
      ...
      <div className="flex items-center gap-3 mt-10 mb-5">
        ...
        <div className='font-semibold opacity-80'>Pipedrive</div>
      </div>
      ...
      className='font-bold text-blue-500 transition hover:text-blue-600 text-left mb-7'>Open person in Pipedrive</button>
      ...
      <div className={`w-full mb-5 ${sec2}`}>
        ...
        <div className='opacity-80'>Back</div>
           ...
           <div className="text-sm mt-3"><span className="text-blue-400 underline font-semibold cursor-pointer">Mike James</span> <span className="text-gray-500">is a contact in your Pipedrive</span></div>
        ...
        <div className="flex items-center gap-5 mb-3 text-sm">
          <BsPhone className="opacity-50 text-lg" />
         +1 123 45 6 77 8
        </div>
        ...
        <div className="rounded-md mt-10 border-2 px-3 py-2 mb-10">
       <div className='font-bold opacity-70 mb-3'>WinterSale Inc.</div>
       <div className="flex gap-3">
         <div>Stage:</div>
         <div className='font-semibold opacity-80'>Lead in</div>
       </div>
       

       <div className="flex gap-3 mt-2">
         <div>Number of notes added:</div>
         <div className='font-semibold opacity-80'>1</div>
       </div>
